...
def counting_game(starts, stop_at=2020):
    ...
    print("Counting to %dth index" % (stop_at,))
    counting_index = 0
    ...
    while counting_index < stop_at:
        ...
        if counting_index % 100000 == 0:
            print("%8d/%d" % (counting_index, stop_at))
...
if __name__ == "__main__":
    ...
    print("Seeds: ", starts)
    print("The 30000000th number is %d" % (counting_game(starts, stop_at=30000000),))